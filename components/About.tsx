        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-orange-900/80 leading-relaxed font-medium">
              आचार्य जी पिछले कई वर्षों से काली माता मंदिर के मुख्य पुजारी के रूप में अपनी सेवाएँ दे रहे हैं। वे वैदिक अनुष्ठान, कर्मकांड और ज्योतिष शास्त्र के प्रकांड विद्वान हैं।
            </p>
